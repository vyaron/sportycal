var Videobox = {
	...
	init: function (options) {
		...
		// Yaron: NOT REALY WORKING... [unknown problem with the extend]
		Object.extend(this.options, overrideOptions);

		//this.options = {initialWidth: 900};
		//alert(this.options.resizeDuration);
		...
		c.setProperty('id', 'lbCenter');
		c.setStyles({width: this.options.initialWidth+'px', 
		...
		this.center.set('morph', {duration: 500, transition: Fx.Transitions.Sine, onComplete: nextEffect});
	...
	open: function(sLinkHref, sLinkTitle, sLinkRel) {
		...
		this.step = 1;
		this.center.setStyle('background','#fff url(/css/videobox/loading.gif) no-repeat center');
