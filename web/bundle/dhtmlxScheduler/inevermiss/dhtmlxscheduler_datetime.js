...
scheduler.form_blocks.datetime = {
	render:function(sns) {
		...
		var reminderHtml = '';
		if (cfg.reminder) {
			reminderHtml = '<select class="reminder" name="reminder" title="reminder"><option value="1">on start</option><option value="60">1 Hour</option><option value="240">4 Hours</option><option value="1440">1 Day</option><option value="20160">2 Weeks</option></select>';
		}
