...
class frontendConfiguration extends sfApplicationConfiguration
{
  ...
  public function initConfiguration(){
  	...
  	if ((strpos(strtolower($_SERVER['HTTP_HOST']), 'inevermiss.') !== false) || (strpos(strtolower($_SERVER['HTTP_HOST']), 'cal4u.') !== false) || $isNevermissTest) sfConfig::set('app_domain_isNeverMiss', true);
