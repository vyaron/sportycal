<?php if (false):?>
<?php decorate_with(sfConfig::get('sf_symfony_lib_dir') . '/controller/default/templates/defaultLayout.php') ?>
...
<?php endif;?>
<div class="c" style="padding-top: 50px;font-size: 14px;color:#555555 ">
