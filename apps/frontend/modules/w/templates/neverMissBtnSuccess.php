...
<style>
.never-miss-btn{background: url('/widgets/neverMiss/imgs/btn.png') no-repeat 0 0; display: block; height:38px; width:129px; text-decoration: none;}
.never-miss-btn.dark{background-image:  url('/widgets/neverMiss/imgs/btn-dark.png');}
.never-miss-btn.yellow{background-image:  url('/widgets/neverMiss/imgs/btn-yellow.png');}

.never-miss-btn.small{background-image: url('/widgets/neverMiss/imgs/btn-small.png'); width: 85px; height: 26px;}
.never-miss-btn.dark.small{background-image:  url('/widgets/neverMiss/imgs/btn-dark-small.png');}
.never-miss-btn.yellow.small{background-image:  url('/widgets/neverMiss/imgs/btn-yellow-small.png');}

.never-miss-btn-txt{color: #6e6e6e; font-family: arial; font-size: 12px; line-height: 12px; margin-left: 50px; margin-top:6px; display: inline-block;}
.only_icon .never-miss-btn-txt{display: none;}
.small .never-miss-btn-txt{font-size: 8px; line-height: 8px; margin-left: 34px; margin-top:4px;}

.dark .never-miss-btn-txt{color:#faad17;}
.yellow .never-miss-btn-txt{color:#000;}
...
.never-miss-btn.only_icon{background-image: url('/widgets/neverMiss/imgs/only-icon.png'); width: 40px; height: 40px;}
.never-miss-btn.only_icon.small{background-image: url('/widgets/neverMiss/imgs/only-icon-small.png'); width: 26px; height: 26px;}
...
.never-miss-btn.only_icon.yellow{background-image: url('/widgets/neverMiss/imgs/only-icon-yellow.png');}
.never-miss-btn.only_icon.yellow.small{background-image: url('/widgets/neverMiss/imgs/only-icon-yellow-small.png');}

.never-miss-btn.disabled{cursor: not-allowed; opacity:0.3; filter:alpha(opacity=30);}


.rtl{text-align: right; direction: rtl;}
.rtl .never-miss-btn-txt{margin-left: 0; margin-right: 5px;}
...
<a class="never-miss-btn<?php echo ($isReachedMaxSubscribers) ? ' disabled' : '';?><?php echo ($isMobile) ? ' mobile' : '';?><?php echo ($btnStyle) ? " $btnStyle" : '';?><?php echo ($btnSize) ? " $btnSize" : '';?><?php echo ($color) ? " $color" : '';?>" <?php echo $href ? 'href="' . $href . '"' : '';?> target="<?php echo $target;?>"<?php echo ($isReachedMaxSubscribers) ? ' title="' .  __('Reached subscriptions limit') . '"' : '';?>>
	<span class="never-miss-btn-txt"><?php echo __('add')?><br/><?php echo __('to calendar');?></span>
</a>
<?php endif;?>
