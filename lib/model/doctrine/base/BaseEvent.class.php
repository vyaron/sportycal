 ...
 * @method Event               setPid()         Sets the current record's "pid" value
 ...
 * @method Event               setEvent()       Sets the current record's "Event" collection
...
abstract class BaseEvent extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('rec_type', 'string', 128, array(
             'type' => 'string',
             'fixed' => 0,
             'unsigned' => false,
             'primary' => false,
